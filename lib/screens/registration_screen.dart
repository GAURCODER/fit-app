...
//             .then((value) => {postDetailsToFirestore(firstName, lastName)})
//             .catchError((e) {
...
//   postDetailsToFirestore(String firstName, String lastName) async {
...
import 'package:fit_app/screens/phoneauth.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // );
    //signup button
    final phonesignUpButton = Material(
      elevation: 5,
      borderRadius: BorderRadius.circular(30),
      color: Colors.redAccent,
      child: MaterialButton(
